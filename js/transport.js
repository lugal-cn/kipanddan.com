  ...
  */
  parseParams : function (params)
  {
    ...
    else if (typeof(params) === "object")
    {
      try
      {
    	  // Fix json conflict with jQuery.
//        legalParams = "JSON=" + params.toJSONString();
    	  legalParams = "JSON=" + objToJSONString();
      }
      catch (ex)
      {
...
// Fix transport.js json conflic with jQuery.
// @link http://www.cnblogs.com/xcp19870712/archive/2012/05/15/2501877.html
...
// End Fix json conflict with jQuery.
