...
function get_consignee_list_billing($user_id)

{

    $sql = "SELECT * FROM " . $GLOBALS['ecs']->table('user_billing_address') .
...
function make_defalut($action ,$id){
	...
	if($action=='shipping'){
		...
		$sql = "UPDATE " . $GLOBALS['ecs']->table('users') .
            ...
            " SET address_billing_id = '$id' WHERE user_id = '$_SESSION[user_id]'";
...
function save_consignee_billing($consignee_billing, $default=false)

{

    if ($consignee_billing['address_id'] > 0)

    {

        /* 修改地址 */

        $res = $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('user_billing_address'), $consignee_billing, 'UPDATE', 'address_id = ' . $consignee_billing['address_id']." AND `user_id`= '".$_SESSION['user_id']."'");
...

    {
        ...
        $res = $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('user_billing_address'), $consignee_billing, 'INSERT');

        $consignee_billing['address_id'] = $GLOBALS['db']->insert_id();
...

    {
        ...
        $sql = "UPDATE " . $GLOBALS['ecs']->table('users') .
            ...
            " SET address_billing_id = '$consignee_billing[address_id]' WHERE user_id = '$_SESSION[user_id]'";
...
function drop_consignee_billing($id)

{

    $sql = "SELECT user_id FROM " .$GLOBALS['ecs']->table('user_billing_address') . " WHERE address_id = '$id'";
...

    {
        ...
        $sql = "DELETE FROM " .$GLOBALS['ecs']->table('user_billing_address') . " WHERE address_id = '$id'";
...

{
...

    {
        ...
        $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('user_billing_address'), $address, 'UPDATE', 'address_id = ' .$address_id . ' AND user_id = ' . $address['user_id']);
...

    {
        ...
        $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('user_billing_address'), $address, 'INSERT');
...

    {
        ...
        $sql = "UPDATE ".$GLOBALS['ecs']->table('users') .
                ...
                " SET address_billing_id = '".$address_id."' ".
