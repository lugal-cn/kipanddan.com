...
$_LANG['back_up_home_page'] = '返回首页';
$_LANG['close_window'] = 'Close window';
$_LANG['back_home'] = 'Go to Home';
$_LANG['ur_here'] = '当前位置:';
...
$_LANG['goods_name'] = 'Item';
$_LANG['goods_attr'] = 'Item details';
...
$_LANG['sign_up'] = 'Register new account';
