...
<?php echo $this->smarty_insert_scripts(array('files'=>'common.js,shopping_flow.js,jquery-1.7.1.min.js')); ?>
...
?>
  ...
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	...
	<?php if ($this->_var['goods_list']['0']['user_id'] == ''): ?>
    	<div class="boxArea">
        	<div class='bag_null'>Your shopping basket is empty, <a href="index.php">continue shopping.</a></div>
        </div>
    <?php else: ?>
		...
		<div class="guocheng">
			...
			<span class="select">1. Shopping basket  >></span>

			<span class="span_r">2. Add/Edit your details  >></span>

			<span class="span_r">3. Payment  >></span>

			<span class="span_r">4. Confirmation</span>
			...
			<form id="formCart" name="formCart" method="post" action="flow.php">
				...
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
					...
					<tr>
						...
						<th bgcolor="#dddddd">Product</th>

						<?php if ($this->_var['show_goods_attribute'] == 1): ?>

							<th bgcolor="#dddddd">SKU</th>

						<?php endif; ?>

						<th bgcolor="#dddddd">Size</th>

						<th bgcolor="#dddddd">Quantity</th>
							...
							<?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
									...
									<?php else: ?>
										...
										<div style="float:left;width:100px;">
											...
											<?php echo $this->_var['goods']['goods_name']; ?><br>color:<?php echo $this->_var['goods']['an_color']; ?>
...
?>
						...
						<?php if ($this->_var['show_goods_attribute'] == 1): ?>
							...
							<td bgcolor="#ffffff"><?php echo $this->_var['goods']['goods_sn']; ?>-<?php echo $this->_var['goods']['an_color_jian']; ?></td>

						<?php endif; ?>

						

							<td align="center" bgcolor="#ffffff"><?php echo $this->_var['goods']['an_size']; ?></td>
							...
							<td align="center" bgcolor="#ffffff">
								...
								<a href="javascript:if (confirm('Remove item from cart?')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="f6">Delete</a>
				...
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
					...
					<tr>
						...
						<td width="25%" style="border-bottom:2px solid #ddd;">
					...
					<tr>
						...
						<td bgcolor="#ffffff" width="50%" style="border-bottom:2px solid #ddd;">
						...
						<td align="center" bgcolor="#ffffff" style="border-bottom:2px solid #ddd;">
							...
							<input type="button" value="<?php echo $this->_var['lang']['clear_cart']; ?>" class="button3" onclick="location.href='flow.php?step=clear'" />

						</td>

						<td align="center" bgcolor="#ffffff" style="border-bottom:2px solid #ddd;">

							<input name="submit" type="submit" class="button3" value="<?php echo $this->_var['lang']['update_cart']; ?>" />
            ...
            <script>
				...
				$(function(){
					...
					$(".button2,.button3").mouseover(function(e){
					...
					$("#continueButton").click(function(){
						...
						$("#checkoutButton").click(function(){
							if($("#terms_box").attr("checked")=="checked"){
								location.href = "flow.php?step=checkout";
							
							}else{
								alert('Please check box to agree to the Terms and Conditions.');
							}
				...
				function popTerms(){					
				var a = window.open('goods.php?act=open_terms','newwindow','height=900,width=800,top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=no,location=no, status=no');
				 a.focus();
				}
			...
			<table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#ffffff">
				...
				<tr>
					...
					<td align="right" bgcolor="#ffffff" colspan="3">
						...
						<input type="checkbox" name="terms_box" checked="checked" value="1" id="terms_box">

						I have read and agree to the <a href="javascript:popTerms();">Terms and Conditions</a> 
				...
				<tr>
					...
					<td width="50%" style="border-bottom:2px solid #ddd;"></td>

					<td bgcolor="#ffffff" style="border-bottom:2px solid #ddd;">

						<!--<a href="./">

							<img src="themes/default/images/continue.gif" alt="continue" />

						</a>

						-->

						<span class="button2" id="continueButton">Continue shopping</span>

					</td>

					<td bgcolor="#ffffff" align="center" style="border-bottom:2px solid #ddd;">

						<!--<a href="flow.php?step=checkout">

							<img src="themes/default/images/checkout.gif" alt="checkout" />

						</a>

						-->

						<span class="button2" id="checkoutButton">Proceed to Checkout</span>
...
?>
						...
						<td bgcolor="#ffffff">
							...
							<a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" class="f6">

								<img src="<?php echo $this->_var['goods']['goods_img']; ?>" width="120px">
							...
							<a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="f6">
...
?>
		...
		<div class="cartBox">
			...
			<div class="guocheng">
				...
				<span>2.Add/Edit your details  >></span>

				<span class="select">3.Payment  >></span>
			...
			<div class="boxArea">
				...
				<div class="infoArea2" >
					<div class="infoModel2" style="float:left">
                    
						<div class="info" style="float:left;width:300px;margin-top:0px">
							<span class="title">Shipping Address:</span>
								<div class="addressBox">
									<span class="con">
										<?php echo htmlspecialchars($this->_var['consignee']['firstname']); ?> <?php echo htmlspecialchars($this->_var['consignee']['surname']); ?><br>
										<?php echo htmlspecialchars($this->_var['consignee']['address']); ?><br><?php echo htmlspecialchars($this->_var['consignee']['city']); ?><br><?php echo htmlspecialchars($this->_var['consignee']['state']); ?><br>
										 <?php $_from = $this->_var['country_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'country');if (count($_from)):
    foreach ($_from AS $this->_var['country']):
?>
						                                                <?php if ($this->_var['consignee']['country'] == $this->_var['country']['region_id']): ?>
						                                                    <?php echo $this->_var['country']['region_name']; ?><br>
						                                                <?php endif; ?>
						                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
										Phone: <?php echo htmlspecialchars($this->_var['consignee']['tel']); ?><br>
										Post code:<?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?><br>
										Email:<?php echo htmlspecialchars($this->_var['consignee']['email']); ?>
									</span>
									<span class="caozuo"><a href="flow.php?step=consignee">edit</a></span>
								</div>
						</div>
						<div class="info" style="float:left;width:300px;margin-top:0px">
							<span class="title">Billing Address:</span>
								<div class="addressBox">
									<span class="con">
										<?php echo htmlspecialchars($this->_var['consignee_billing']['firstname']); ?> <?php echo htmlspecialchars($this->_var['consignee_billing']['surname']); ?><br>
										<?php echo htmlspecialchars($this->_var['consignee_billing']['address']); ?><br><?php echo htmlspecialchars($this->_var['consignee_billing']['city']); ?><br><?php echo htmlspecialchars($this->_var['consignee_billing']['state']); ?><br>
										 <?php $_from = $this->_var['country_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'country');if (count($_from)):
    foreach ($_from AS $this->_var['country']):
?>
					                                                <?php if ($this->_var['consignee']['country'] == $this->_var['country']['region_id']): ?>
					                                                ...
					                                                <?php endif; ?>
					                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
										Tel: <?php echo htmlspecialchars($this->_var['consignee_billing']['tel']); ?><br>
										Post code:<?php echo htmlspecialchars($this->_var['consignee_billing']['zipcode']); ?><br>
										Email:<?php echo htmlspecialchars($this->_var['consignee_billing']['email']); ?>
									</span>
									<span class="caozuo"><a href="flow.php?step=consignee">edit</a></span>
								</div>
							</span>	
				...
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
					...
					<tr>
						...
						<th bgcolor="#dddddd" style="font-size:13px">Product</th>

						<th bgcolor="#dddddd" style="font-size:13px">SKU</th>

						<th bgcolor="#dddddd" style="font-size:13px">Size</th>

						<th bgcolor="#dddddd" style="font-size:13px">Quantity</th>

						<th bgcolor="#dddddd" style="font-size:13px">Price</th>

						<th bgcolor="#dddddd" style="font-size:13px"></th>
...
?>
					...
					<tr>
						...
						<td bgcolor="#ffffff" align="center" width="40%" style="font-size:13px">
...
?>
							...
							<td align="center" bgcolor="#ffffff" style="font-size:13px"><?php echo $this->_var['goods']['goods_sn']; ?>-<?php echo $this->_var['goods']['an_color_jian']; ?></td>

							<td align="center" bgcolor="#ffffff" style="font-size:13px"><?php echo $this->_var['goods']['an_size']; ?></td>

							<td align="center" bgcolor="#ffffff" style="font-size:13px"><?php echo $this->_var['goods']['goods_number']; ?></td>

							<td align="center" bgcolor="#ffffff" style="font-size:13px">$<?php echo $this->_var['goods']['subtotal']; ?></td>

							<td align="center" bgcolor="#ffffff" style="font-size:13px"><a href="flow.php">edit</a></td>
				...
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
					...
					<tr>
						...
						<td width="35%" style="border-bottom:2px solid #ddd;font-size:13px" align="center" bgcolor="#ffffff">
						...
						<td width="35%" style="border-bottom:2px solid #ddd;font-size:13px" align="center" bgcolor="#ffffff">
							...
							<input name="validate_bonus" type="button" class="button3" value="Apply discount" onclick="validateBonus(document.forms['theForm'].elements['bonus_sn'].value)" style="vertical-align:middle;" />
					...
					<tr>
						...
						<td width="30%" style="font-size:13px;font-weight:bold" align="center" bgcolor="#ffffff">1. Select shipping type:</td>
...
<?php echo $this->_var['shipping']['shipping_name']; ?>
					...
					<tr>
						...
						<td width="30%" style="font-size:13px; font-weight:bold" align="center" bgcolor="#ffffff">2. Select payment type:</td> 
            ...
            <div id="ECS_ORDERTOTAL">
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
					...
					<tr>
						...
						<td width="25%" style="border-bottom:2px solid #ddd;font-size:13px" align="center" bgcolor="#ffffff"><?php echo $this->_var['total']['shipping_fee_formated']; ?></td>
					...
					<tr>
						...
						<td width="25%" style="border-bottom:2px solid #ddd;font-size:13px" align="center" bgcolor="#ffffff">-<?php echo $this->_var['total']['bonus_formated']; ?></td>
					...
					<tr>
						...
						<td width="25%" style="border-bottom:2px solid #ddd;font-size:13px" align="center" bgcolor="#ffffff"><?php echo $this->_var['total']['amount_formated']; ?></td>
...
-->
		...
		<div class="done_cartBox">
        	<div class="done_title">
            	<div style="font-weight:bold">CONFIRM PAYMENT</div>
            	<div>
                	<?php echo $this->_var['lang']['order_amount']; ?>: <strong><?php echo $this->_var['total']['amount_formated']; ?></strong><BR>
...
?>
		...
		$(function(){
			...
			$("#registerButton").click(function(){
					...
					if(user == '' || pwd == ''){
						$("#info_area").html("<div style='color:red'>required field</div>");
					}else if(emailPattern.test(user) != true){
						$("#info_area").html("<div style='color:red'>please note our prompt, change your registration information</div>");
					}else{
						if(window.confirm("Do you want to register'"+ user +"'?"))
						  {
							$("#actInput").attr("value","signup");
							$("#loginForm").submit();
						  }
						  else
						  {
		...
		<div class="cartBox">
			...
			<div class="guocheng">
				...
				<span>1.Shopping basket</span><span>>></span>

				<span class="select">2.Add/Edit your details</span><span>>></span>
			...
			<div class="boxArea"  style="background-color:#fff">
				...
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
					...
					<tr>
						...
						<td bgcolor="#ffffff">Sign in or create account.</td>

						<td bgcolor="#ffffff">Checkout without Kipanddan account</td>
					...
					<tr>
						...
						<td width="50%" valign="top" bgcolor="#ffffff">
							...
							<form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
								...
								<table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#ffffff" class="table">

									<tr>

										<td bgcolor="#ffffff" width="20%"></td>

										<td bgcolor="#ffffff" width="80%" style="text-align:left">

											Create an account for quick checkout.

											With an account you can save all of your

											details, save and view your wishlist, look

											over past orders and receive emails about
									...
									<tr>
										...
										<td bgcolor="#ffffff"><div align="left">Email</div></td>

										<td bgcolor="#ffffff"><input name="email" type="text" class="inputBg2" id="email" onblur="checkEmail(this.value);" /></td>

									</tr>

									<tr>

										<td bgcolor="#ffffff"><div align="left">Password</div></td>

										<td bgcolor="#ffffff"><input name="password" class="inputBg2" id="pwd" type="password" /></td>
									...
									<tr>
										...
										<td bgcolor="#ffffff"><div align="left"><strong><?php echo $this->_var['lang']['comment_captcha']; ?>:</strong></div></td>
									...
									<tr>
										...
										<td bgcolor="#ffffff" colspan="2" align="center">
											...
											<!--<a href="user.php?act=qpassword_name" class="f6"><?php echo $this->_var['lang']['get_password_by_question']; ?></a>&nbsp;&nbsp;&nbsp;-->

											<a href="user.php?act=get_password" target="_blank">(Forgot your password?)</a>
								...
								<script>
									...
									$(function(){
										...
										$(".buttonCss").mouseover(function(e){
								...
								<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff">
									...
									<tr>
										...
										<td bgcolor="#ffffff">
											...
											<div align="center">
												...
												<input type="button" id="loginButton" class="button3 buttonCss" name="login" value="Sign in" />
										...
										<td bgcolor="#ffffff">
											...
											<div align="center">
												...
												<input type="button" id="registerButton" name="Submit" class="button3 buttonCss" value="Create account" />

												<input name="act" id="actInput" type="hidden" value="signin" />
									...
									<tr>
										<td bgcolor="#ffffff" colspan="2" id="info_area">We promise to keep your email address confidential.</td>
									</tr>
						...
						<td  bgcolor="#ffffff">
								...
								<?php if ($this->_var['anonymous_buy'] == 1): ?>
									...
									<div align="center">
										...
										<input type="button" class="button4 buttonCss" value="Add your shipping details here" onclick="location.href='flow.php?step=consignee&amp;direct_shopping=1'" />
