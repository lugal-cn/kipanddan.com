...
$_LANG['stock_insufficiency'] = "Sorry, we currently only have %d of %s in stock. Please CONTACT US if you would like to order more.";
$_LANG['package_stock_insufficiency'] = "Sorry, we currently only have %d of %s in stock. Please CONTACT US if you would like to order more.";
...
$_LANG['invalid_bonus'] = " The promotion code you have entered does not exist or has already been redeemed.";
...
$_LANG['select_payment'] = "Your selected payment method is";
$_LANG['order_amount'] = "The total of your order is";
