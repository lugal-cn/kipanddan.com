...
$_LANG['require_login'] = 'Login required.';
...
$_LANG['detail_order_sn'] = 'Order Number';
...
$_LANG['detail_to_buyer'] = 'Leave message for seller';



$_LANG['confirm_time'] = 'Confirmed on %s';

$_LANG['pay_time'] = 'Paid on %s';

$_LANG['shipping_time'] = 'Shipped on %s';



$_LANG['select_payment'] = 'Payment method selected';

$_LANG['order_amount'] = 'Total amount';

$_LANG['update_address'] = 'Update details of receiver';

$_LANG['virtual_card_info'] = 'virtual card';
...
$_LANG['login_success'] = 'Login successful!';
...
$_LANG['email_empty'] = 'email required';

$_LANG['email_invalid'] = '%s is not a valid email';

$_LANG['email_exist'] = '%s has already been registered.';

$_LANG['email_not_allow'] = '%s is not a valid email';

$_LANG['register'] = 'register new user';

$_LANG['register_success'] = 'Registration successful';
